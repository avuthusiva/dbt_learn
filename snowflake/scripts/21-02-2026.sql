...
update products set price = 46,created_at=current_timestamp() where id = 200;
select * from dbt_db.bronze.bronze_products where id = 200;
select * from dbt_db.bronze.bronze_orders where id = 10;
select * from DBT_DB.DBT_TEST__AUDIT.UNIQUE_PRODUCTS_SNAPSHOT_CATEGORY;
select * from orders;